...
if __name__=='__main__':
	...
	usage='''python netcon.py [OPTIONS]

	some common usage are: 
		python netcon.py -i DIR -t 10 -m 50 -p 80
		[ launch the full script with default parameters ] 
		#
		python new_net_constr_fake.py -y -l TARGET
		[ launch the script with only omology part, and limited to TARGET genome ]
		#
		python new_net_constr_fake.py -z -b ORTH_FILES
		[ launch the script with gexf files as input, and skip BBH ] 
	'''
